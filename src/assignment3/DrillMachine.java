...
/**
 * The DrillMachine class represents the player-controlled drill machine in the
 * game. It handles movement, fuel management, hauling, and interaction with the
 * game world.
 */
public class DrillMachine {
	...
	/**
	 * Constructs a new DrillMachine object with the specified initial position.
	 * 
	...
	/**
	 * Moves the drill machine in the specified direction.
	 *
	 * @param direction The direction in which to move the drill machine.
	 */
	...
	/**
	 * Applies gravity to the drill machine, causing it to fall downward if there's
	 * empty space below. The falling speed is determined by the haul weight of the
	 * drill machine.
	 */
	...
	/**
	 * Changes the asset image of the drill machine based on its current direction.
	 */
	...
	/**
	 * Loads the asset images for different directions of the drill machine.
	 */
	...
	/**
	 * Updates the fuel value displayed on the screen.
	 *
	 * @param fuelText The text object to display the fuel value.
	 */
	...
	/**
	 * Updates the haul weight displayed on the screen.
	 *
	 * @param haulText The text object to display the haul weight.
	 */
	...
	/**
	 * Updates the money displayed on the screen.
	 *
	 * @param moneyText The text object to display the money.
	 */
